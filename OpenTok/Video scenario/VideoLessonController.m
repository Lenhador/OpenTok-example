...
- (void) createSession
{
    ...
    if(!jsonResponse)
    {
        UIAlertView *error = [[UIAlertView alloc] initWithTitle:@"Error" message:@"Internet connection is missing" delegate:self cancelButtonTitle:@"ок" otherButtonTitles: nil];
        [error show];
        return;
    }
